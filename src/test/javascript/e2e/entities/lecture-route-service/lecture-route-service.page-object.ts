...
export class LectureComponentsPage {
    ...
    deleteButtons = element.all(by.css('jhi-lecture-route-service div table .btn-danger'));
    title = element.all(by.css('jhi-lecture-route-service div h2#page-heading span')).first();
...
export class LectureUpdatePage {
    pageTitle = element(by.id('jhi-lecture-route-service-heading'));
