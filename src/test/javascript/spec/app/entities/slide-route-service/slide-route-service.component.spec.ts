...
import { SlideRouteServiceComponent } from 'app/entities/slide-route-service/slide-route-service.component';
...
describe('Component Tests', () => {
    describe('SlideRouteService Management Component', () => {
        let comp: SlideRouteServiceComponent;
        let fixture: ComponentFixture<SlideRouteServiceComponent>;
        let service: SlideRouteServiceService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [LecturePlannerTestModule],
                declarations: [SlideRouteServiceComponent],
                providers: [
                    {
                ...
                .overrideTemplate(SlideRouteServiceComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(SlideRouteServiceComponent);
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new SlideRouteService(123)],
                        headers
                    })
                )
            );
