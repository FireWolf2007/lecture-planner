package ru.wolfa.lecture.planner.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("LecturePlanner");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("LecturePlanner");
        ...
        config.getMapConfigs().put("ru.wolfa.lecture.planner.domain.*", initializeDomainMapConfig(jHipsterProperties));
